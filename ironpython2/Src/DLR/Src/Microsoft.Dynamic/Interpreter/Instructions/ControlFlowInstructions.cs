...
namespace AnyPrefix.Microsoft.Scripting.Interpreter {
    ...
    internal sealed class SwitchInstruction : Instruction {
        private readonly MyDictionary<int, int> _cases;

        internal SwitchInstruction(MyDictionary<int, int> cases) {
    ...
    internal sealed class EnterLoopInstruction : Instruction {
        ...
        private MyDictionary<ParameterExpression, LocalVariable> _variables;
        private MyDictionary<ParameterExpression, LocalVariable> _closureVariables;
